  ...
  return (
      <section className='common-padding'>
          <div className='screen-max-width'>
              ...
              <div className='mt-10 md:mt-20 mb-14 2xl:pl-[15rem] w-[-15rem]'>
                  <div className='relative h-full flex-center'>
                      <div className='overflow-hidden'>
                          <img src={frameImg} alt='frame' className='bg-transparent relative z-10 2xl:pr-[10rem]' />
                      </div>
                  ...
                  <p className='text-gray font-semibold text-center mt-3'>Honkar: Star Rail</p>
                  </div>
                  <div className='chip-text-container xl:pl-[20rem]'>
                      ...
                      <p className='chip-text g_fadeIn'>
                          ...
                          with incredibly detailed environments and charaters.
                      </p>
                  </div>
